...
<body>
        ...
        <a href = "<?php echo base_url();?>index.php/site/logout" class="btn btn-danger btn-sm">Logout</a>
                ...
                <a  href="#" class="btn btn-sm btn-hover btn-primary"  data-toggle="modal" data-target="#exampleModal<?php echo $query->query_id;?>" href="" ><span class="glyphicon glyphicon-share-alt" style="padding-right:3px;"></span>Reply</a>
                  <a href="<?php echo base_url();?>index.php/students/dont_show/<?php echo $query->query_id;?>" class="btn btn-sm btn-hover btn-danger"><span class="glyphicon glyphicon-remove" style="padding-right:3px;"></span>Don't Show Again</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url();?>index.php/students/reply_to_student_query/<?php echo $query->query_id;?>">
          
          <div class="form-group">
            <label for="message-text" class="control-label">Your Reply</label>
            <textarea class="form-control" id="message-text" rows='9' name="reply" requiredrequired></textarea>
          </div>
