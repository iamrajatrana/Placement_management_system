  ...
  <div id="w">
    <div align="center" id="content">
      ...
      <div class="notify successbox">
        ...
        <p>Messege Sent Successfullly</p><br>
        <?php
        if($this->session->userdata('designation') == 'student')
        {

        ?>
               <a class="btn btn-success" href="<?php echo base_url();?>index.php/site/welcome_back">Go Home</a>
               <?php
             }
             else
             {
              ?>
               <a class="btn btn-success" href="<?php echo base_url();?>index.php/home/view_profile">Go Home</a>
              <?php
             }
             ?>
      </div>
