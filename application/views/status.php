  ...
  <div id="w">
    <div id="content">
      ...
      <?php
        ...
        ?>
        <div align="center"> 
        	<a class="btn btn-success" href="<?php echo base_url();?>index.php/site/add_student">Add Student</a>
			<a class="btn btn-success" href="<?php echo base_url();?>index.php/site/add_recruiter">Add Recruiter</a>
        </div>
