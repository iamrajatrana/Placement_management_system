  ...
  <div id="w">
    <div id="content">
      ...
      <div align="center" class="notify successbox">
        ...
        <p>Your Profile Updated. Please go Home</p><br>
        <?php
        if($this->session->userdata('designation')=='admin')
        {
                  
            ?>
        <a class="btn btn-success" href = "<?php echo base_url();?>index.php/site/admin">Home</a>
        <?php
      }
      else
      {
        ?>
               ...
               <a class="btn btn-success" href = "<?php echo base_url();?>index.php/site/student_area">Home</a>
        <?php
      }
      ?>
      </div>
